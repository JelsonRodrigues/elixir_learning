defmodule ExemplosSort do
  ...
  def insertion_sort_remove_duplicates([h|t]), do: ExemplosSort.ins_remove_duplicates(h, ExemplosSort.insertion_sort_remove_duplicates(t))
  ...
  def insertion_sort_reverse([h|t]), do: ExemplosSort.ins_reverse(h, ExemplosSort.insertion_sort_reverse(t))
end
